    ...
    public function data()
    {
        ...
        return Datatables::of($indexs)
            ->addColumn('actions', function ($indexs) {
                $actions = '<a href=' . route('test1.test1a.index.show', ['index_id' => $indexs->index_id]) . '><i class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="update index"></i></a>
