<ul id="menu" class="page-sidebar-menu">
    ...
    <li {!! (Request::is('admin/adtech/core/role/*') || Request::is('admin/adtech/core/user/*') ||
     ...
     Request::is('admin/adtech/core/file/*')) ? 'class="active"' : '' !!}>
        ...
        <ul class="sub-menu">
            <li {!! (Request::is('admin/adtech/core/role/manage') ? 'class="active"' : '') !!}>
            ...
            <li {!! (Request::is('admin/adtech/core/user/manage') ? 'class="active"' : '') !!}>
            ...
            <li {!! (Request::is('admin/adtech/core/domain/manage') ? 'class="active"' : '') !!}>
